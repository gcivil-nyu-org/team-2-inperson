  ...
  <div class="card-container">
    <div class="card-header">
      <a href="https://stuy.enschool.org/"
        ><div class="detail-school-name">
          {{ schoolDetailData.name }}
        </div></a
      >
      <div class="detail-school-borough">
        {{ schoolDetailData.borough }}
      </div>
    </div>
    <!-- <div class="column_wrapper"> -->
    <div class="dimension-rows">
      <template
        v-for="dimension in schoolDetailData.dimensions"
        :key="dimension"
      >
