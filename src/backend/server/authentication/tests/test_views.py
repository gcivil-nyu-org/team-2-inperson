...
class TestViews(TestSetUp):
    ...
    def test_user_can_register_correctly(self):
        with patch("authentication.utils.Util.send_email") as mocked_email:
            ...
            self.assertEqual(email_call["email_subject"], "Verify your email", "email subject matches")
            self.assertEqual(email_call["to_email"], self.user_data["email"], "email to address matches")
